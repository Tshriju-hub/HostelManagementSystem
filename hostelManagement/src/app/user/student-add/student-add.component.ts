...
// Room No 
  ...
  constructor(private router: Router, private userService: UserService) {
    ...
    this.userService.boysSuperDeluxRooms().subscribe((total) => { 
      for (let i of total) {
        this.boysSuperDeluxRoomNo = this.boysSuperDeluxRoomNo.concat(i.roomNo);
      }
      this.boysSuperDeluxRooms = total;
    });
    this.userService.boysDeluxRooms().subscribe((total) => { 
      for (let i of total) {
  ...
  addStudent() {
    ...
    this.userService.addStudent(student).subscribe(s => {
      alert(s);
      this.router.navigate(['/user/viewStudent']);
    });
  }
